...
namespace TarnRouter {
    ...
    std::pair<std::vector<std::pair<const TarnData, size_t>>, std::vector<const Node*>> find_shortest_path_between_tarns(const Graph& graph, std::vector<TarnData>& tarn, const double min_dist_per_day);
}
